<?php
	...
	*/
	...
	if(isset($_POST['frmAddPlayer']))
	{
		...
		$dbObj = mysqli_select_db( $dbConn, "gregs_gambits");
		...
		$sqlStatement="INSERT INTO contact (last_Name, first_Name, username, email, avatar, weapon1, weapon2, weapon3, supply1, supply2, supply3, supply4, supply5) 
		VALUES ('$_POST[lastName]','$_POST[firstName]','$_POST[username]','$_POST[email]', '$_POST[avatar]', '$_POST[weapon_one]', '$_POST[weapon_two]', '$_POST[weapon_three]' 
		 '$_POST[supply_one]', '$_POST[supply_two]', '$_POST[supply_three]', '$_POST[supply_four]', '$_POST[supply_five]')" ;
